...
## RESULT:
Thus the program has been executed by unrolling by 8 and unrolling by 16. It is observed that 524288 has executed with less elapsed time than 1048576 with blocks 2.93 ms,120.69 ms.
